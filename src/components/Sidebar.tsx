        ...
        {activeTab === 'layers' && (
          <div className="space-y-6">
            ...
            <div className="space-y-2 border border-green-900/40 rounded p-3 bg-black/40 text-xs">
              ...
              <button className={`w-full p-2 border rounded flex items-center justify-center gap-2 ${performance.forceFastMode ? 'border-green-500 bg-green-900/30' : 'border-green-900/50'}`} onClick={() => setPerformance({ forceFastMode: !performance.forceFastMode })}><Zap size={14} /> Fast Mode</button>
